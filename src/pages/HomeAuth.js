...
const HomeAuth = () => {
  ...
  const fetchAllNfts = async () => {
    ...
    const options = {
      chain: "mumbai",
      address: "0x7078c17AFA308b61D122a3ACe71C1d1Da3db1Fe4",
    };
  ...
  return (
    ...
    <div className="homeAuth_container">
      ...
      <div className="homeAuth_subHeader"><p>(If you can't see the blogs, double click on the icon of the page you're in)</p></div>
